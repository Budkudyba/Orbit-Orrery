...
ID3D10InputLayout* InputLayout::Line				= 0;
...
void InputLayout::InitAll(ID3D10Device* device)
{
	...
	//
	// Position-normal-texture vertex --SPHERE
	//
	...
	// 
	// Position-tangent-normal-texture vertex --MESH
	//
	...
	// Line vertex
	//
	D3D10_INPUT_ELEMENT_DESC vertexDescLine[] =
	{
		{"POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 0, D3D10_INPUT_PER_VERTEX_DATA, 0},
		{"COLOR",   0, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, 12, D3D10_INPUT_PER_VERTEX_DATA, 0},
	};

    fx::LineFX->GetTechniqueByName("LineTech")->GetPassByIndex(0)->GetDesc(&PassDesc);
    HR(device->CreateInputLayout(vertexDescLine, 2, PassDesc.pIAInputSignature,
